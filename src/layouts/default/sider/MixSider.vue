...
const [displayName, bem] = createNamespace("layout-mix-sider");
...
.z-layout-mix-sider {
  ...
  top: 0;
  left: 0;
  z-index: var(--layout-mix-sider-fixed-z-index);
  height: 100%;
  overflow: hidden;
  ...
  @border-color: var(--sider-dark-lighten-bg-color);
  ...
  &-trigger {
    ...
    text-align: center;
    cursor: pointer;
    background-color: var(--trigger-dark-bg-color);
    height: 36px;
    line-height: 36px;
  }
